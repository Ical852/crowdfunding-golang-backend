...
func (h *campaignHandler) CreateImage(c *gin.Context) {
	...
	existingCampaign, err := h.campaignService.GetCampaignByID(campaign.GetCampainDetailInput{ID: id})
	if err != nil {
		c.HTML(http.StatusInternalServerError, "error.html", nil)
		return
	}
...
func (h *campaignHandler) Update(c *gin.Context) {
	...
	_, err = h.campaignService.UpdateCampaign(campaign.GetCampainDetailInput{ID: id}, updateInput)
	if err != nil {
		c.HTML(http.StatusInternalServerError, "error.html", nil)
		return
	}
